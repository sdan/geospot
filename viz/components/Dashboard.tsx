...
// Sample chart colors matching Tinker
const CHART_COLORS = {
  red: "#ef4444",
  lime: "#84cc16",
  amber: "#f59e0b",
...
const MODELS = [
  ...
  { name: "gpt-oss-120b", color: CHART_COLORS.teal, key: "model6" },
  { name: "DeepSeek-V3.1", color: CHART_COLORS.blue, key: "model7" },
  { name: "gpt-oss-20b", color: CHART_COLORS.green, key: "model8" },
];
...
const generateTimeSeriesData = (days = 30) => {
  ...
  for (let i = days; i >= 0; i--) {
    ...
    data.push({
      ...
      reward: 0.5 + Math.random() * 0.4 + (days - i) * 0.01, // Increasing reward trend
...
const generateModelBreakdownData = (days = 30) => {
  ...
  for (let i = days; i >= 0; i--) {
    ...
    data.push({
      ...
      model7: Math.random() * 15,
      model8: Math.random() * 4,
    });
  }
  return data;
};
      ...
      <Card className="shadow-none">
        <CardHeader className="pb-3">
          <div className="space-y-0.5">
            ...
            <CardDescription>
              View and manage your VLM training runs
            </CardDescription>
          </div>
        </CardHeader>
        <CardContent>
